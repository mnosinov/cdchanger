...
INSTALLED_APPS = [
    ...
    'crispy_forms',
    'formtools',
    'cdchanger.apps.CdchangerConfig',
]
...
ROOT_URLCONF = 'cdchanger_project.urls'
...
WSGI_APPLICATION = 'cdchanger_project.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'cdchanger_project/static'),
]
